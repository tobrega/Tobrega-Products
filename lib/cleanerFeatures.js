...
// const originFilePath = path.join(__dirname, '../data/example/features.csv');
// const destinationFilePath = path.join(__dirname, '../data/example/featuresCleaned.csv');
const originFilePath = path.join(__dirname, '../data/features.csv');
const destinationFilePath = path.join(__dirname, '../data/featuresCleaned.csv');
